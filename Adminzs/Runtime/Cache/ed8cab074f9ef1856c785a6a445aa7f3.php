...
<link href="__PUBLIC__/meadmin/assets/css/login.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="__PUBLIC__/meadmin/plugins/nprogress/nprogress.js"></script>
<script type="text/javascript" src="__PUBLIC__/meadmin/assets/js/login.js"></script>
...
<body class="login">
<div class="logo"> <img src="__PUBLIC__/meadmin/assets/img/logo.png" alt="logo" /> <strong> 后台登录</strong></div>
<div class="box">
  <div class="content">
    <form class="form-vertical login-form" action="<?php echo U('Public/login');?>" method="post">
      <h3 class="form-title"> 登录 </h3>
      <div class="alert fade in alert-danger" style="display: none;"> <i class="icon-remove close" data-dismiss="alert"> </i> 输入任何用户名密码进入. </div>
...
<script type="text/javascript">
  if (location.host == "envato.stammtec.de" || location.host == "themes.stammtec.de") {
    ...
    var data = $('.login-form').serialize();
		...
		var url2 = "<?php echo U('index/index');?>";
